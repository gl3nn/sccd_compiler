...
namespace SCCDEditor{
    public class Compile
    {
        ...
        public static void compile()
        {
            ...
            try {
                Compiler.generate(Path.Combine(Application.dataPath, "xml/classdiagram/editor.xml"), Path.Combine(Application.dataPath, "Editor/classdiagram_editor.cs"), CodeGenerator.Platform.GAMELOOP);
